...
- 한국어 예시:
   |<span style="display: inline-block; width:300px">구분</span>|줄 수|한 줄당<br>문자의<br>최대 개수|
   |-|-|-|
   |저희 업소에서는 남은 음식물을 재활용하지 않습니다.|1|28|
   |저희 업소에서는 남은 음식물을 재활용하지↵않습니다.|2|22|
   |저희 업소에서는 남은 음식물을↵재활용하지 않습니다.|2|16|
   |저희 업소에서는 남은↵음식물을 재활용하지↵않습니다.|3|11|
   |저희 업소에서는↵남은 음식물을↵재활용하지↵않습니다.|4|8|
   |저희↵업소에서는↵남은 음식물을↵재활용하지↵않습니다.|5|7|
...
- 일본어 예시:
   ...
   |-|-|-|
   |当店では残飯を再活用しません。|1|15|
   |当店では残飯を再活用↵しません。|2|10|
   |当店では残飯を再↵活用しません。|2|8|
   |当店では残飯を↵再活用↵しません。|3|7|
   |当店では↵残飯を再活用↵しません。|3|6|
   |当店では↵残飯を再↵活用↵しません。|4|5|
- 중국어 예시:
   |<span style="display: inline-block; width:300px">구분</span>|줄 수|한 줄당<br>문자의<br>최대 개수|
   |-|-|-|
   |本店绝不使用剩菜。|1|9|
