...
# Work Experience
- ['플리토' ('Flitto') (2022.05 ~ 2023.12)](#플리토-flitto-202205--202312-정규직)
- ['HDC현대산업개발' (2016.07 ~ 2022.04)](#hdc현대산업개발-201607--202204-정규직)
## '플리토' ('Flitto') (2022.05 ~ 2023.12, 정규직)
- 퇴직 사유:
- 회사 소개:
...
### Scene text removal model 개발 (2022.09 ~ 2023.01)
...
## 'HDC현대산업개발' (2016.07 ~ 2022.04, 정규직)
- 이직 사유:
###	Tableau 기반의 전사 대시보드 구축 리드 (2021.02 ~ 2022.04)
...
### 아파트 실거래가 데이터 분석 리드 (2020.01 ~ 2020.11)
...
# Foreign Languages
## English
- 영어로 작성된 논문을 읽고 이해하는 데 문제 없음.
## Japanese
- 초중급 정도의 말하기, 읽기, 듣기 가능.
