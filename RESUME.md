...
- Scene text remover로 원본 이미지에서 번역이 필요한 텍스트를 지우고 기계번역과 전문가 번역을 거친 번역문을 Scene text renderer로 렌더링하는 과정을 거쳐 번역된 메뉴 이미지가 만들어집니다.
...
###	Tableau를 사용한 EIS 구축 (2021.02 ~ 2022.04)
