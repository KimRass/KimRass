...
|2017|[Pix2Pix](https://github.com/KimRass/Pix2Pix)<br>Isola et al.|[✓] Experimenting on image mean and std<br>[✓] Experimenting on `nn.InstanceNorm2d()`[✓] Training on Google Maps<br>[✓] Training on Facades<br>[ㅤ] higher resolution input image|
