...
- 'text region score map'을 사용해 각 문자의 중심 (Pseudo Character Center (PCC) [7])을 추출합니다.
...
### (4) 모델 평가
- 규칙 기반 방법론과 학습 기반 방법론 각각에 대하여, [6]을 사용해 이미지의 모든 텍스트를 제거하고 정답 이미지와 비교했습니다. (이 방법은 일부의 텍스트만을 제거하는 실제 사용 사례를 정확히 반영하지는 않습니다.)
  |방법론|PSNR (↑)|SSIM (↑)|MSE (↓)|
  |-|-|-|-|
...
- [6] [SCUT-EnsText](https://github.com/HCIILAB/SCUT-EnsText)
- [7] [CLEval: Character-Level Evaluation for Text Detection and Recognition Tasks](https://arxiv.org/abs/2006.06244)
